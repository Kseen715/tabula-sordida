...
- `index.html` lists every `<LANG>/*.html` page. It is generated by `build_index.py`; rerun that after adding, removing or retitling a page, and don't edit `index.html` by hand.
